<?php
/**
 * Corregir los numeros de un turno de sabado ya cargado (typo en el
 * extracto). Exclusivo del admin. Se puede corregir cualquier turno de
 * su ciclo; SorteoService vuelve a cotejar la secuencia completa.
 */
...
$pageTitle   = 'Corregir turno · ' . APP_NAME;
$navSeccion  = 'sabados';
...
<main class="pantalla">
    ...
    <a href="<?= APP_URL ?>/admin/sabados/ver.php?id=<?= (int) $ciclo['id'] ?>"
       class="btn btn-sm btn-outline-secondary mb-3">
        <i class="bi bi-arrow-left"></i> Sábado <?= (int) $ciclo['numero'] ?>
    </a>

    <?php require __DIR__ . '/../../includes/flash.php'; ?>

    <h1 class="pantalla__titulo">Corregir turno</h1>
    <p class="pantalla__bajada">
        Turno <?= (int) $sorteo['turno'] ?> de 5 · Sábado <?= (int) $ciclo['numero'] ?>
    </p>
        ...
        <form method="post" id="form-sorteo"
            ...
            <section class="tarjeta p-3 mt-3">
                <div class="d-flex align-items-start justify-content-between gap-2 mb-2">
                    <div>
                        <span class="rotulo">Turno <?= (int) $sorteo['turno'] ?> de 5</span>
