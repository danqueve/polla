<?php
/**
 * Corregir los números de un sorteo ya cargado con estilo Gentelella.
 */
...
$navSeccion       = 'sorteos';
$pageSectionTitle = 'Editar Extracto';
...
<main class="g-content">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4 g-animate">
        <div>
            <div class="d-flex align-items-center gap-2">
                ...
                <span class="g-badge g-badge--warning">Edición / Corrección</span>
            </div>
            <h1 class="g-page-title mt-2">Corregir Extracto Oficial</h1>
            <p class="g-page-subtitle">
                <?= e(formatFechaDia($sorteo['fecha'])) ?> · Semana del <?= e(CicloService::rotulo($ciclo)) ?>
            </p>
        </div>

        <div>
            <a href="<?= APP_URL ?>/admin/sorteos/index.php?ciclo=<?= (int) $ciclo['id'] ?>" class="g-btn g-btn--outline">
    ...
    <?php if (!$chequeo['permitido']): ?>
        ...
        <div class="g-card p-5 text-center text-secondary g-animate g-animate-delay-1">
            ...
            <h4 class="fw-bold text-dark">No es posible corregir este extracto</h4>
            ...
            <div class="g-card mb-4 g-animate g-animate-delay-1">
                <div class="g-card__header">
                    <h3 class="g-card__title">
                        ...
                        Los <?= $cantidad ?> Números Corregidos del Extracto
                    </h3>
        ...
        <div class="accion-fija">
            <div class="accion-fija__interior d-flex align-items-center gap-3">
                ...
                <button type="submit" form="form-sorteo" id="btn-confirmar"
                    ...
                    Guardar Corrección y Re-cotejar
                </button>
            </div>
        </div>
